    ...
    <RootLayout>
      <div className="min-h-screen py-16 lg:py-24">
        <div className="container mx-auto max-w-4xl px-4">
          {/* Page title kept outside prose to avoid extra margins */}
          <h1 className="text-4xl font-bold tracking-tight mb-8">Privacy Policy</h1>

          {/* Info banner excluded from Typography plugin */}
          <div className="not-prose bg-blue-50 dark:bg-blue-900/20 border border-blue-100/60 dark:border-blue-900/30 p-6 rounded-lg mb-10">
            ...
            <p className="text-sm text-blue-800 dark:text-blue-200">
              This Privacy Policy explains how Advontier (“we,” “us,” or “our”) collects, uses, and protects your
          ...
          <article className="prose prose-lg prose-gray dark:prose-invert max-w-none [&>p]:mb-6 [&>ul]:mb-6 [&>ol]:mb-6 [&>li]:mb-2 [&>h2]:mt-12 [&>h2]:mb-6 [&>h3]:mt-8 [&>h3]:mb-4 leading-relaxed">
            ...
            <ul>
              ...
              <li><strong>Government Identification:</strong> South African ID numbers, passport numbers, business registration details</li>
            ...
            <ul>
              ...
              <li>Compliance with South African labor laws and regulations</li>
            ...
            <ul>
              <li>South African government authorities and regulators</li>
            ...
            <ul>
              ...
              <li><strong>Financial Records:</strong> 5 years as required by South African law</li>
              <li><strong>Client Data:</strong> Duration of business relationship plus 3 years</li>
              <li><strong>Marketing Data:</strong> Until consent is withdrawn</li>
            </ul>

            <h2>5. Your Rights Under POPIA and GDPR</h2>

            <p>As a data subject, you have the following rights under South Africa's Protection of Personal Information Act (POPIA) and the General Data Protection Regulation (GDPR):</p>
            ...
            <p>We may transfer your personal information outside South Africa to:</p>
            <ul>
            ...
            <ul>
              <li>South African Information Regulator</li>
              <li>Your local data protection regulator</li>
              <li>European Data Protection Board (for EU residents)</li>
            </ul>
          </article>

          <div className="not-prose bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-100/60 dark:border-yellow-900/30 p-6 rounded-lg mt-10">
            <h3 className="text-yellow-800 dark:text-yellow-200 font-semibold mb-2">Important Notice</h3>
            <p className="text-sm text-yellow-800 dark:text-yellow-200">
              This Privacy Policy is part of our terms of service. By using our services, you acknowledge that you have
