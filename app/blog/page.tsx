...
export default async function Blog() {
  ...
  return (
    <RootLayout>
      <PageIntro eyebrow="Research" title="The latest research and insights">
        <p>
          Research and planning for the future of Advontier's practice management and 2 sided marketplace platform.
        </p>
      </PageIntro>
