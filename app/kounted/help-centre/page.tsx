// app/kounted/help-centre/page.tsx
  ...
  return (
    <div className="rounded-lg  p-3 bg-card space-y-3">
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          <label className="text-xs text-zinc-400">Author Name</label>
          <Input value={row.author_name || ''} onChange={e => onChange({ ...row, author_name: e.target.value })} />
        </div>
        <div>
          <label className="text-xs text-zinc-400">Author Role</label>
          <Input value={row.author_role || ''} onChange={e => onChange({ ...row, author_role: e.target.value })} />
        </div>
        <div>
          <label className="text-xs text-zinc-400">Author Image URL</label>
