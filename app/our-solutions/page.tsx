...
const logoFamilyFund = '/clients/family-fund/logo-dark.svg'
const logoGreenLife = '/clients/green-life/logo-dark.svg'
const logoHomeWork = '/clients/home-work/logo-dark.svg'
const logoMailSmirk = '/clients/mail-smirk/logo-dark.svg'
const logoNorthAdventures = '/clients/north-adventures/logo-dark.svg'
            ...
            <li key={client} className="group">
              <FadeIn className="overflow-hidden">
                <Border className="pt-12 group-nth-[-n+2]:-mt-px sm:group-nth-3:-mt-px lg:group-nth-4:-mt-px">
                  <Image src={logo} alt={client} width={64} height={64} unoptimized />
                </Border>
              </FadeIn>
            </li>
          ))}
...
export default async function Work() {
  ...
  return (
    <RootLayout>
      ...
      >
        <p>
         Our results speak for themselves. But don't take our word for it, here are some of our clients to explain how we've helped them.
        </p>
      </PageIntro>
