...
import { Border } from '@/components/react-layout/Border'
...
export function Blockquote(
  ...
  if (props.image) {
    return <BlockquoteWithImage {...(props as React.ComponentPropsWithoutRef<typeof BlockquoteWithImage>)} />
  }

  return <BlockquoteWithoutImage {...(props as React.ComponentPropsWithoutRef<typeof BlockquoteWithoutImage>)} />
}
