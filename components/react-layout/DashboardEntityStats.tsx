// components/kounted/DashboardEntityStats.tsx
...
export default function DashboardEntityStats({ metrics }: Props) {
  return (
    <div className="rounded-xl px-6 py-0">
      <h3 className="text-xs font-semibold text-zinc-400 m-4">Year-to-date: 2025 vs 2024 (For illustration purposes only)</h3>
        ...
        return (
          <Card key={metric.label} className="relative overflow-hidden rounded-lg bg-card px-2 pt-2 pb-12 shadow-sm sm:px-6 sm:pt-6">
            <dt>
              ...
              <p className="ml-12 truncate text-xs font-medium text-zinc-400">
                {metric.label}
              </p>
            </dt>
            ...
            {metric.link && (
              <div className="absolute inset-x-0 bottom-0 bg-zinc-100 px-4 py-4 sm:px-6">
                <div className="text-xs">
                  <a href={metric.link} className="font-semibold text-zinc-400 hover:text-primary hover:underline underline-offset-2">
