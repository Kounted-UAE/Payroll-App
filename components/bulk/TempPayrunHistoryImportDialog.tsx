      ...
      <DialogContent className="max-w-4xl max-h-[95vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          <div className="relative inline-block">
            <label
              htmlFor="csv-upload"
              className="flex items-center gap-2 px-4 py-2 text-xs font-medium text-blue-700 border border-border rounded-md bg-background cursor-pointer transition-colors hover:bg-accent hover:text-accent-foreground"
            >
