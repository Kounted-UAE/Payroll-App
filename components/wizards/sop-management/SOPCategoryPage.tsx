...
const sampleSOPs = [
  {
    ...
    description:
      'Complete guide for registering companies for Corporate Tax with FTA',
    status: 'active',
  ...
  },
  {
    ...
    description:
      'Annual trade license renewal process for mainland and free zone companies',
    status: 'active',
  ...
  },
  {
    ...
    description:
      'UBO registration requirements and process for UAE companies',
    status: 'active',
...
export default function SOPCategoryPage() {
        ...
        <div className="max-w-4xl mx-auto">
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <Button onClick={() => goTo('/sop-resources')}>
  ...
  const handleSOPClick = (sopId: string) => {
    goTo(`/sop-resources/${category}/${sopId}`)
  }
    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          <Button variant="outline" onClick={() => goTo('/sop-resources')}>
            <ArrowLeft className="mr-2 h-4 w-4" />
            Back to SOP Center
          </Button>
