  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-zinc-400 rounded-md w-10 h-8 font-normal text-xs flex items-center justify-center",
        row: "flex w-full",
        ...
        day_selected:
          "bg-zinc-500 text-white hover:bg-zinc-600 focus:bg-zinc-500 focus:text-white rounded-md",
