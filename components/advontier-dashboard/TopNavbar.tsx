...
export function TopNavbar() {
  ...
  return (
    <header className="text-sm h-24 text-zinc-100 bg-gradient-to-r from-slate-900 to-slate-600 shadow-sm shadow-zinc-100 font-semibold backdrop-blur supports-[backdrop-filter]:bg-zinc-900 top-0 z-50 sticky overflow-hidden">
