...
import {
  ...
  DrawerFooter,
  DrawerClose,
} from '@/components/react-ui/drawer'
...
import { Select, SelectTrigger, SelectValue, SelectContent, SelectItem } from '@/components/react-ui/select'
            ...
            return (
              <div>
                ...
                {isView || isDelete ? (
                  ...
                  <Input
                    value={(formData[field as string] as string) || ''}
