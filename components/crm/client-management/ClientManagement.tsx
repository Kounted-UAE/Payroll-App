...
import { ActionButtons } from '@/components/react-ui/action-buttons';
import ClientActionsDialog from '@/components/crm/client-management/ClientActionsDialog';
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-zinc-400">Manage clients and their onboarding progress</p>
          </div>
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                {filteredClients.map((client) => {
                  ...
                  return (
                    <div key={client.id} className="border rounded-lg p-4 hover:bg-zinc-100/50 transition-colors">
                      <div className="flex items-center justify-between">
