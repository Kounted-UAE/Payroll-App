...
import { Footer } from '@/components/advontier-ui/Footer'
...
import { SocialMedia } from '@/components/advontier-ui/SocialMedia'
  ...
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
      ...
      <NavigationItem href="/about">About Us</NavigationItem>
        <NavigationItem href="/articles">Our Thoughts</NavigationItem>
            </NavigationRow>
            <NavigationRow>
              <NavigationItem href="/our-results">Our Solutions</NavigationItem>
