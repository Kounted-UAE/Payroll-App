...
import OrderActionsDialog from '@/components/business-development/kiosk/KioskWizard';
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {filteredOrders.map((order) => (
                <div key={order.id} className="border rounded-lg p-4 hover:bg-zinc-100/50 transition-colors">
