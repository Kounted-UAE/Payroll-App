        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <span className="text-xs text-zinc-400">Receive a customized proposal by email</span>
            </Button>
            ...
            >
              ...
              <span className="text-xs text-zinc-400">Schedule a consultation with our team</span>
            </Button>
            ...
            >
              ...
              <span className="text-xs text-zinc-400">Move directly to contract signing</span>
            </Button>
          </div>
        </div>
      </FormSection>
