 ...
 * Intended for admin/manual workflows under `app/backyard/admin/...`.
...
const styles = StyleSheet.create({
  ...
  companyInfo: { flex: 1 },
  companyName: { fontSize: 24, fontWeight: 'bold', color: '#1e293b', marginBottom: 8 },
  payslipTitle: { fontSize: 28, fontWeight: 'bold', color: '#2563eb', textAlign: 'right' },
  employeeSection: { marginBottom: 25, padding: 15, backgroundColor: '#f8fafc', borderRadius: 8 },
  sectionTitle: { fontSize: 14, fontWeight: 'bold', color: '#1e293b', marginBottom: 12, borderBottom: '1 solid #e2e8f0', paddingBottom: 5 },
  employeeGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 20 },
  employeeField: { minWidth: '45%', marginBottom: 8 },
  fieldLabel: { fontSize: 9, color: '#64748b', marginBottom: 2 },
  fieldValue: { fontSize: 11, color: '#1e293b', fontWeight: 'bold' },
  payPeriodSection: { marginBottom: 25, padding: 15, backgroundColor: '#eff6ff', borderRadius: 8, borderLeft: '4 solid #2563eb' },
  payPeriodTitle: { fontSize: 12, fontWeight: 'bold', color: '#1e40af', marginBottom: 8 },
  payPeriodText: { fontSize: 14, color: '#1e293b', fontWeight: 'bold' },
  salarySection: { marginBottom: 25 },
  tableHeader: { flexDirection: 'row', backgroundColor: '#f1f5f9', borderBottom: '1 solid #e2e8f0' },
  tableHeaderCell: { flex: 1, padding: 10, fontSize: 10, fontWeight: 'bold', color: '#475569', textAlign: 'center' },
  tableRow: { flexDirection: 'row', borderBottom: '1 solid #f1f5f9' },
  tableRowLast: { flexDirection: 'row', borderBottom: 'none' },
  tableCellLeft: { flex: 1, padding: 8, fontSize: 9, color: '#374151', textAlign: 'left' },
  tableCellRight: { flex: 1, padding: 8, fontSize: 9, color: '#374151', textAlign: 'right' },
  totalSection: { marginTop: 15, padding: 15, backgroundColor: '#f0fdf4', borderRadius: 6, border: '2 solid #16a34a' },
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 5 },
  totalLabel: { fontSize: 12, fontWeight: 'bold', color: '#15803d' },
  totalValue: { fontSize: 14, fontWeight: 'bold', color: '#15803d' },
  netSalaryRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderTop: '1 solid #bbf7d0', paddingTop: 8, marginTop: 8 },
  netSalaryLabel: { fontSize: 14, fontWeight: 'bold', color: '#166534' },
  netSalaryValue: { fontSize: 16, fontWeight: 'bold', color: '#166534' },
  footer: { marginTop: 30, paddingTop: 20, borderTop: '1 solid #e2e8f0', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' },
  footerLeft: { flex: 1 },
  footerText: { fontSize: 8, color: '#64748b', lineHeight: 1.3 }
})
...
const PayslipDocument: React.FC<PayslipInput> = ({ employee, batch }) => {
  ...
  const salaryBreakdown = [
    { label: 'Basic Salary', amount: employee.basic_salary },
    { label: 'Housing Allowance', amount: employee.housing_allowance },
    { label: 'Education Allowance', amount: employee.education_allowance },
    { label: 'Flight Allowance', amount: employee.flight_allowance },
    { label: 'General Allowance', amount: employee.general_allowance },
    { label: 'Gratuity/EOSB', amount: employee.gratuity_eosb },
    { label: 'Other Allowance', amount: employee.other_allowance },
    { label: 'Bonus', amount: employee.bonus },
    { label: 'Overtime', amount: employee.overtime },
    { label: 'Salary in Arrears', amount: employee.salary_in_arrears },
    { label: 'Adhoc Expenses', amount: employee.expenses_deductions },
    { label: 'School Reimbursements', amount: employee.other_reimbursements },
    { label: 'Internet Reimbursements', amount: employee.expense_reimbursements }
...
export async function generatePayslipPDFAdmin(data: PayslipInput): Promise<Blob> {
  ...
  for await (const chunk of stream) {
    ...
    } else if (typeof Buffer !== 'undefined' && (chunk as any) instanceof Buffer) {
